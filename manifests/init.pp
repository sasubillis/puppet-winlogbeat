...
class winlogbeat (
  ...
  if $use_chocolatey {
    $default_config_file = 'C:/ProgramData/chocolatey/lib/winlogbeat/winlogbeat.yml'
  }
  else {
  ...
  if $use_chocolatey {
    $default_registry_file = 'C:/ProgramData/chocolatey/lib/winlogbeat/.winlogbeat.yml'
  }
  else {
